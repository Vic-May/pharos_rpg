    ...
    stances: [
      {
        ...
        maneuver:
          "Inimigos que entrarem no seu alcance provocam um Ataque de Oportunidade.",
        recovery:
    ...
    stances: [
      {
        ...
        benefit:
          "Como Ação Bônus, escolha um aliado a até 3m. Ele ganha Vantagem em uma qualquer rolagem (ataque, teste ou resistência) até o início do seu próximo turno.",
        restriction:
