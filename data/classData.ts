    ...
    stances: [
      {
        ...
        benefit:
          "Ao lançar qualquer magia, role 1d4 adicional para definir a Qualidade do Caos: 1 = Catástrofe (2d100, menor resultado), 2 = Calmaria (nada acontece), 3 = Fluxo (1d100 normal), 4 = Perfeição (2d100, maior resultado).",
        restriction:
