...
export const MAGIC_SCHOOLS: MagicSchoolData[] = [
  {
    ...
    spells: [
      ...
      },
      {
        ...
        effect:
          "Ataque a 24m. 3d6+INT perfurante. Falha em CON perde metade do deslocamento.",
        cost: 4,
        isAttack: true,
        damageFormula: "3d6",
        actionType: "standard",
    ...
    spells: [
      {
        ...
        effect: "3 projéteis a 18m. Acerto automático. 1d4 fogo cada.",
        cost: 2,
        isAttack: false,
        actionType: "standard",
        damageFormula: "1d4",
      },
      {
        ...
        effect: "Cone de 9m. Salvaguarda DES. 2d6+INT fogo (metade se passar).",
        cost: 2,
        isAttack: false,
        actionType: "standard",
      },
      ...
      },
      {
        ...
        effect: "Alvo faz Salvaguarda SAB ou entra em Fúria (Ataca próximo).",
        cost: 4,
        isAttack: false,
        actionType: "standard",
      },
      {
        ...
        effect: "Causa 3d6 fogo. Se segurando: Salvaguarda CON para soltar.",
        cost: 4,
        isAttack: false,
        damageFormula: "3d6",
        actionType: "standard",
      },
      {
        ...
        effect: "Explosão raio 6m a 36m. Salvaguarda DES. 5d6 fogo.",
        cost: 6,
        isAttack: false,
        damageFormula: "5d6",
        actionType: "standard",
  ...
  },
  {
    ...
    spells: [
      ...
      },
      {
        ...
        effect: "Ataque a 18m. 2d6+INT impacto.",
        cost: 2,
        isAttack: true,
        damageFormula: "2d6",
        actionType: "standard",
      },
      {
        ...
        effect: "Parede de 3x1m adjacente. Concede Cobertura Leve.",
        cost: 2,
        isAttack: false,
        actionType: "standard",
      },
      {
        ...
        effect:
          "Inimigo no chão a 18m. 2d6+INT e Salvaguarda FOR ou Imobilizado.",
        cost: 4,
        isAttack: false,
        damageFormula: "2d6",
        actionType: "standard",
      },
      {
        ...
        effect: "Cone 6m. Salvaguarda FOR. 2d8 impacto e Prostrado.",
        cost: 4,
        isAttack: false,
        actionType: "standard",
      },
      {
        ...
        effect: "Raio 6m a 24m. Salvaguarda DES. 4d6 perfurante.",
        cost: 6,
        isAttack: false,
        damageFormula: "4d6",
        actionType: "standard",
  ...
  },
  {
    ...
    spells: [
      ...
      },
      {
        ...
        effect: "Luz Plena 9m raio a até 18m. Anula invisibilidade.",
        cost: 4,
        isAttack: false,
        actionType: "standard",
      },
      ...
      },
      {
        ...
        effect: "Cilindro 3m raio. Salvaguarda CON. 4d8+INT radiante e Cego.",
        cost: 6,
        isAttack: false,
        damageFormula: "4d8",
        actionType: "standard",
  ...
  },
  {
    ...
    spells: [
      ...
      },
      {
        ...
        effect: "3 alvos. Salvaguarda DES. 3d6 (primário) e 1d6 (outros).",
        cost: 4,
        isAttack: false,
        actionType: "standard",
      },
      {
        ...
        effect: "Teleporte 9m para espaço visível.",
        cost: 4,
        isAttack: false,
        actionType: "bonus",
      },
  ...
  },
  {
    ...
    spells: [
      ...
      },
      {
        ...
        effect: "Esfera 6m raio. Silêncio total. Bloqueia verbal.",
        cost: 4,
        isAttack: false,
        actionType: "standard",
      },
      {
        ...
        effect:
          "4d6+INT (Objeto/Golem) OU 3d6+INT e -1 CA (Criatura com armadura).",
        cost: 4,
        isAttack: false,
        actionType: "standard",
      },
      ...
      },
      {
        ...
        effect: "Raio 9m a 24m. Salvaguarda INT. 3d8 psíquico e Atordoado.",
        cost: 6,
        isAttack: false,
        damageFormula: "3d8",
        actionType: "standard",
  ...
  },
  {
    ...
    spells: [
      ...
      },
      {
        ...
        effect: "Ataque. 1d8+INT veneno. Salvaguarda CON ou Envenenado.",
        cost: 2,
        isAttack: true,
        damageFormula: "1d8",
        actionType: "standard",
      ...
      },
      {
        ...
        effect: "Raio 4,5m. Salvaguarda SAB. 50% Fuga / 50% Luta.",
        cost: 6,
        isAttack: false,
        actionType: "standard",
      },
  ...
  },
  {
    ...
    spells: [
      ...
      },
      {
        ...
        effect:
          "Cone 9m. Salvaguarda FOR. Empurra 6m e colisão 2d6+INT (falha) ou 3m (sucesso).",
        cost: 2,
        isAttack: false,
        actionType: "standard",
      },
      {
        ...
        effect: "Voo 9m (10 min). Vantagem ataque vs chão.",
        cost: 4,
        isAttack: false,
        actionType: "standard",
      },
      ...
      },
      {
        ...
        effect:
          "Alvo a 18m. Salvaguarda SAB ou Paralisado. Falha repetida causa 4d8.",
        cost: 6,
        isAttack: false,
        actionType: "standard",
      },
